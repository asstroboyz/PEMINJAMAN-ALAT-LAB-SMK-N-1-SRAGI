        ...
        <div class="col-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h3>Daftar nama kategori</h3>
                    <a href="/Admin/tambah_kategori" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Kategori</a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <?php if ($kategori) { ?>
                                <?php foreach ($kategori as $num => $data) { ?>
                                <tr>
                                    <td><?= $num + 1; ?></td>
